...
upBound=0.5;
lowBound=-2.0;
maxFront=40;%front-back
maxBack=0;
maxLeft=20;%left-right
maxRight=-maxLeft;
resolution=0.05;
...
if ~exist(calib_label_dir,'dir')
    ...
    for idx1=0:7480
        ...
        for idx2=1:numel(label)
            ...
            fprintf(fw,'%s %d %d %d %d %f %f %f %f %f\n',label(idx2).type,left,up,right,down,...
                label(idx2).ry,label(idx2).l,label(idx2).w,label(idx2).h,pos_lidar(3));
...
if ~exist('./CarBirdVOCdevkit2007/VOC2007','dir')
    mkdir('./CarBirdVOCdevkit2007/VOC2007/Annotations');
%     mkdir('./CarBirdVOCdevkit2007/VOC2007/JPEGImages')
...
for i=0:7480
    ...
    have_car=kitti_to_voc(calib_label_dir,i);
end
